...
3. Use Regression With ARIMA Errors as next step.



### Model 3: Regression With ARIMA Errors

#### Apply Seasonal Differencing to Make Highly Correlated Regressors Stationary
```{r}
library(forecast)
...
### Model 4: Dynamic Harmonic Regression(Optimize for K ; different frequencies)
#### Periodogram
```{r}
...
### Dynamic Harmonic Regression [Used expanding window and 7-day forecast horizon for cross-validation]
```{r}
library(forecast)
...
## 4. Future Forecast using Dynamic Harmonic Regression
```{r}
